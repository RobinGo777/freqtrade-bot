...
# GROQ_API_KEY removed — Groq disabled
...
# GROQ_MODEL removed — Groq disabled
...
async def generate_content(rubric: str, history: list, extra: dict = None) -> dict:
    ...
    log.error(f"❌ All Gemini models failed for [{rubric}] — SKIPPING POST")
